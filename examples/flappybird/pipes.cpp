...
void Pipes::makeFloor() {
  // Generate VBO
  abcg::glGenBuffers(1, &m_VBOFloor);
  abcg::glBindBuffer(GL_ARRAY_BUFFER, m_VBOFloor);
  ...
  // Create VAO
  abcg::glGenVertexArrays(1, &m_VAOFloor);
...
void Pipes::makeCeil() {
  // Generate VBO
  abcg::glGenBuffers(1, &m_VBOCeil);
  abcg::glBindBuffer(GL_ARRAY_BUFFER, m_VBOCeil);
  abcg::glBufferData(GL_ARRAY_BUFFER, ceilPoints.size() * sizeof(glm::vec2),
                     ceilPoints.data(), GL_STATIC_DRAW);
  abcg::glBindBuffer(GL_ARRAY_BUFFER, 0);
  ...
  // Create VAO
  abcg::glGenVertexArrays(1, &m_VAOCeil);
